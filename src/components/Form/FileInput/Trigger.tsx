/**
 * Trigger é a parte visível do input de arquivo.
 */
...
export function Trigger() {
  ...
  return (
    <label
      ...
      htmlFor={id}
    >
      <div className="rounded-full border-6 border-zinc-50 bg-violet-50 group-hover:border-violet-50 group-hover:bg-violet-100 ">
