    ...
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5">
      <div className="space-y-1">
        ...
        <div className="space-x-3">
          <button
            type="button"
            className="text-sm font-medium text-violet-500 hover:scale-105 hover:text-violet-700"
          >
            Dimmis
          </button>
          <button
            type="button"
            className="text-sm font-medium text-violet-700 hover:scale-105 hover:text-violet-900"
          >
            Upgrade Plan
          </button>
        </div>
